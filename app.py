...
with col1:
    if audio_file is not None:
        try:
            # Predict emotion from audio metadata
...
if audio_file is not None and text_input:
    try:
        ...
        # Predict probability distribution for text
        ...
        # Decode combined prediction using text label encoder
    ...
    # Friendly messages if combined prediction is not applicable
